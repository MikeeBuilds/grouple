    ...
    <div>
      {htmlContent && !onEdit && inline ? (
        ...
        <EditorRoot>
          ...
          >
            <EditorCommand className="z-50 h-auto max-h-[330px] w-72 overflow-y-auto rounded-md border border-muted bg-background px-1 py-2 shadow-md trans"></EditorCommand>
          </EditorContent>
        </EditorRoot>
      )}
    </div>
