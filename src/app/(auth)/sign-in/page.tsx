...
const SignInPage = () => {
  return (
    <>
      <h5 className="font-bold text-themeTextWhite text-center text-2xl mb-4">Login</h5>
    ...
    <li>Cultivate skills, grow your network, and thrive with Cannova</li>
      ...
      <div className="my-10 w-full relative">
        ...
        <Separator orientation="horizontal" className="bg-themeGray" aria-label="or continue with" />
      </div>
